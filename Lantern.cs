...
namespace StorybrewScripts
{
    public class Lantern : StoryboardObjectGenerator
    {
        public override void Generate()
        {
            ...
            var lantern1 = layFore.CreateSprite(@"SB\2dx_91.png", OsbOrigin.Centre, new Vector2(505, -135));
            lantern1.MoveY(788, -135);
            lantern1.MoveY(1682, 2031, -135, 40);
            lantern1.MoveY(2031, 2114, 40, 20);
            lantern1.MoveY(2114, 5097, 20, -20);

            var lantern2 = layFore.CreateSprite(@"SB\2dx_91.png", OsbOrigin.Centre, new Vector2(135, -135));
